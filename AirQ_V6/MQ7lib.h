...
{
  public:
    MQ7lib(String Placa = "Arduino", float Voltage_Resolution =  5,float ADC_voltage_resolution = 5, int ADC_Bit_Resolution = 10, int pin = 1, String type = "CUSTOM MQ");
    MQ7lib(String Placa = "Arduino", String type = "CUSTOM MQ");
    ...
    void setVoltResolution(float voltage_resolution =  5);
  	void setADCVoltResolution(float ADC_voltage_resolution = 5);
  ...
  private:
	...
	float _ADC_voltage_resolution = 5; // diferencia entre adc de placa y alimentacion del sensor
